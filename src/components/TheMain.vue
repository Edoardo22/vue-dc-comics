<template>
    <div>
        <div class="fluid-container bg-dark-grey">
            <div class="container-fluid jumbotron position-relative">
                <div class="container">
                    <div class="bg-primary tag p-3 text-white fs-3"><strong> CURRENT SERIES</strong></div>
                </div>
            </div>
            <div class="container py-5">
                <div class="row">
                    <div class="col col-2 " v-for="(comic, i) in comicsList" :key="i">
                        <img class="comic-main" :src="comic.thumb" alt="">
                        <div class="text-light">{{ comic.series }}</div>
                    </div>
                </div>
            </div>
